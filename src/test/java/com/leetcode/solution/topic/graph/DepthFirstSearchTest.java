...
class DepthFirstSearchTest {
    @InjectMocks
    DepthFirstSearch leetcode;


    @Test
    void testDFSSmallVal() {
        int[][] array = {{0, 1}, {1,2}, {3, 2}};
        List<Integer> undirectedList = leetcode.dfsUndirected(4, array, 0);
    ...
    void testUndirectedDFS() {
        ...
        List<Integer> undirectedList = leetcode.dfsUndirected(8, array, 0);
    ...
    void testUndirected() {
        int[][] array = {{0, 1}, {1, 4}, {1, 5}, {0, 2}, {2, 3}, {2, 6}, {6, 7}, {3, 7}};
        List<Integer> undirectedList = leetcode.dfsUndirected(8, array, 1);
        assertEquals(8, undirectedList.size());
